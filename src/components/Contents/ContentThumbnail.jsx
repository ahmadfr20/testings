...
import './contents.css';
import Contents from "../../assets/images/Contents/contents.png";
import Bg1 from "../../assets/images/Contents/circle.png";
  ...
  return (
   ...
   <section className='w-h-screen bg-gray-800 h-full' id='ContentThumbnail' style={{ backgroundImage: `url(${Bg1})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
    <div className='justify-center w-full text-center py-10 mx-auto'>
      ...
      <h1 class="font-blueberry mt-32 mb-10 font-bold text-white text-5xl max max-md:text-4xl max-xl:text-5xl dark:text-white">
          <span className='font-blueberry font-bold' style={{ color: "#01C587"}}>#Wawasan</span> dari berbagai sudut <br /> pandang kehidupan
      </h1>

      <h1 className="font-blueberrymd w-full text-lg text-white max-md:text-xl my-4">
