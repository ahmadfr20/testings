...
import disesuaikan from '../../assets/disesuaikan.png'
import mingguan from '../../assets/mingguan.png'
...
const Products = () => {
  ...
  return (
    <div class="container px-5 w-full py-24 mx-auto flex flex-wrap" id='product'>
        <div className="flex flex-col items-center justify-center  max-w-full px-4 pt-16 mx-auto sm:max-w-xl md:max-w-4xl lg:pt-32 md:px-8">
          <h1 class="font-blueberry text-3xl font-bold text-center text-black lg:text-4xl ">Kenali <span className='font-bold' style={{ color: "#01C587"}}>#Dimulai</span> dan fitur menariknya Lebih dalam lagi</h1>
            <br />
            <p class="font-blueberrymd max-w-full text-xl mx-auto mt-4 text-center text-black xl:mt-6 ">
        ...
        <div className="lg:py-6 lg:pr-16">
          <div className="flex">
            <div className="flex flex-col items-center mr-4">
              ...
              <img src={global} class="mr-20 h-20 w-20 rounded-full" alt="Logo" />
            </button>
              </div>
          ...
          <div className="flex flex-col items-center mr-4">
              <div>
                <button class="bg-grey-light hover:bg-grey text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center">
                <img src={disesuaikan} class="mr-20 h-20 w-20 rounded-full" alt="Logo" />
                </button>
              </div>
            </div>
            <div className="pt-1 pb-8 w-full">
          ...
          <div className="flex flex-col items-center mr-4">
              <div>
                <button class="bg-grey-light hover:bg-grey text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center">
                <img src={mingguan} class="mr-20 h-20 w-20 rounded-full" alt="Logo" />
                </button>
              </div>
            </div>
            <div className=" pt-1 pb-8 w-full">
